import { DocumentNode, FragmentSpreadNode, NamedTypeNode, FieldNode } from 'graphql';
import { CompletionItem, Diagnostic, Uri, IPosition, Outline, GraphQLCache, HoverConfig, DefinitionQueryResult } from 'graphql-language-service';
...
export declare class GraphQLLanguageService {
    ...
    _getDefinitionForField(query: string, _ast: DocumentNode, _node: FieldNode, _filePath: Uri, projectConfig: GraphQLProjectConfig, position: IPosition): Promise<DefinitionQueryResult | null>;
