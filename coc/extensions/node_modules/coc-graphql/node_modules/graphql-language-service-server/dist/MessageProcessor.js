...
class MessageProcessor {
    constructor({ logger, fileExtensions, graphqlFileExtensions, loadConfigOptions, config, parser, tmpDir, connection, }) {
        ...
        this._tmpDir = tmpDir || (0, os_1.tmpdir)();
        ...
        if (!(0, fs_1.existsSync)(this._tmpDirBase)) {
            (0, mkdirp_1.default)(this._tmpDirBase);
        }
    }
    get connection() {
    ...
    _handleConfigError({ err }) {
        var _a;
        if (err instanceof graphql_config_1.ConfigNotFoundError) {
        ...
        else if (err instanceof graphql_config_1.ConfigEmptyError) {
            this._logConfigError(err.message);
        }
    ...
    async handleDidOpenOrSaveNotification(params) {
        ...
        if ('text' in textDocument && textDocument.text) {
            ...
            const configMatchers = [
                ...
                'graphqlrc',
                'package.json',
                (_a = this._settings.load) === null || _a === void 0 ? void 0 : _a.fileName,
            ].filter(Boolean);
            if (configMatchers.some(v => { var _a; return (_a = uri.match(v)) === null || _a === void 0 ? void 0 : _a.length; })) {
        ...
        if (!this._graphQLCache) {
            ...
            try {
                ...
                if (this._isInitialized &&
                    ((_c = (_b = project === null || project === void 0 ? void 0 : project.extensions) === null || _b === void 0 ? void 0 : _b.languageService) === null || _c === void 0 ? void 0 : _c.enableValidation) !== false) {
    ...
    async handleWatchedFilesChangedNotification(params) {
        ...
        return Promise.all(params.changes.map(async (change) => {
            ...
            else if (change.type === graphql_language_service_1.FileChangeTypeKind.Created ||
                change.type === graphql_language_service_1.FileChangeTypeKind.Changed) {
                const uri = change.uri;
                const text = (0, fs_1.readFileSync)(vscode_uri_1.URI.parse(uri).fsPath, 'utf-8');
    ...
    async _cacheSchemaFile(uri, project) {
        uri = uri.toString();
        const isFileUri = (0, fs_1.existsSync)(uri);
        let version = 1;
        if (isFileUri) {
            ...
            const schemaText = (0, fs_1.readFileSync)(uri, { encoding: 'utf-8' });
    ...
    _getTmpProjectPath(project, prependWithProtocol = true, appendPath) {
        ...
        if (!(0, fs_1.existsSync)(projectTmpPath)) {
            (0, mkdirp_1.default)(projectTmpPath);
        }
        if (appendPath) {
    ...
    async _cacheConfigSchema(project) {
        try {
            ...
            if (schema) {
                ...
                if (cachedSchemaDoc) {
                    (0, fs_1.writeFileSync)(fsPath, schemaText, {
                        encoding: 'utf-8',
                    });
